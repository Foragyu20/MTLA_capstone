...
class IlocanoAddList extends StatefulWidget {
  const IlocanoAddList({Key? key}) : super(key: key);

  @override
  IlocanoAddListState createState() => IlocanoAddListState();
}

class IlocanoAddListState extends State<IlocanoAddList> {
  ...
  Future<void> aRecordz(
    ...
    String translatedwordpangasinan,
    String translatedwordtagalog,
  ) async {
    final response = await http.post(
      Uri.parse(Api.ilodic),
      body: {
        'word': word,
        ...
        'translated_word_pangasinan': translatedwordpangasinan,
    ...
    Column(
      ...
      children: [
        Container(
          ...
          child:
          ListTile(title: Image.asset('assets/ilocanoaddedword.png',)),
          ),
        Container(
          color: const Color.fromARGB(255, 98, 221, 96),
          child:  
