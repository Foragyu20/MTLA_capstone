...
class TagalogAddList extends StatefulWidget {
  const TagalogAddList({Key? key}) : super(key: key);

  @override
  TagalogAddListState createState() => TagalogAddListState();
}

class TagalogAddListState extends State<TagalogAddList> {
    ...
    Column(
      ...
      children: [
        Container(
          ...
          child:
          ListTile(title: Image.asset('assets/Filaddedword.png',), ),
          ),
        Container(
          color: const Color.fromARGB(255, 255, 164, 173),
          child:  
